 ...
 */
export const isInRangeMinutes = (nowMin, startMin, endMin) => {
 ...
 */
export const shouldUseCurrentColor = (nowMin, startMin, endMin) => isInRangeMinutes(nowMin, startMin, endMin);

export { shouldUseCurrentColor as decideColor };
 ...
 */
export const getTaipeiMinutes = (date = new Date()) => {
...
export const makePng1x1RGBA = (r, g, b, a = 255) => {
...
export default {
	async fetch(request) {
		...
		const useCurrent = shouldUseCurrentColor(nowMin, startMin, endMin);
